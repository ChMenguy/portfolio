                            ...
                            <div className="row">
                                <div className="col col-md-8 col-sm-12 slide-caption">
                                    ...
                                    <div className="slide-title">
                                        ...
                                        <h4 style={{color:"white"}}>Professionnel du developpement et passionné de crossfit, je met à votre service mon expertise et mon énergie pour vous aider à relever vos défis</h4>
                                    </div>
                                    <div className="btns">
